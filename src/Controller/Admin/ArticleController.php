...
class ArticleController extends AbstractController
{
    ...
    public function upload(
        ...
        #[MapUploadedFile(
            new Image(
                maxSize: '8',
                maxSizeMessage: 'The image is too large. Maximum size is {{ limit }} MB.',
                mimeTypes: ['image/jpeg', 'image/png', 'image/gif', 'image/webp', 'image/svg+xml', 'image/jpg', 'image/avif'],
                mimeTypesMessage: 'The image must be a valid image file (JPEG, PNG, GIF, WebP, SVG, JPG, AVIF).',
